...
nohup java -jar $QANARY/qanary_component-NED-Babelfy/target/qanary_component-NED-Babelfy-1.0.0.jar 2>$QANARY_LOG/qanary_component-NED-Babelfy.errorlog 1>$QANARY_LOG/qanary_component-NED-Babelfy.outlog &
