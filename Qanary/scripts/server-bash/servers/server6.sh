...
nohup java -jar $QANARY/qanary_component-NED-Aylien/target/qanary_component-NED-Aylien-1.0.0.jar 2>$QANARY_LOG/qanary_component-NED-Aylien.errorlog 1>$QANARY_LOG/qanary_component-NED-Aylien.outlog &
