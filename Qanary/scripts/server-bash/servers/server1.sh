...
nohup java -jar $QANARY/qanary_component-NED-DBpedia-Spotlight/target/qanary_component-NED-DBpedia-Spotlight-1.0.0.jar 2>$QANARY_LOG/qanary_component-NED-DBpedia-Spotlight.errorlog 1>$QANARY_LOG/qanary_component-NED-DBpedia-Spotlight.outlog &
