...
nohup java -jar $QANARY/qanary_component-NED-Ontotext/target/qanary_component-NED-Ontotext-1.0.0.jar 2>$QANARY_LOG/qanary_component-NED-Ontotext.errorlog 1>$QANARY_LOG/qanary_component-NED-Ontotext.outlog &
