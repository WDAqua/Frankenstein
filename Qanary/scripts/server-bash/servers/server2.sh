...
nohup java -jar $QANARY/qanary_component-NERD-Lucene-Linker/target/qanary_component-NERD-Lucene-Linker-1.0.0.jar 2>$QANARY_LOG/qanary_component-NERD-Lucene-Linker.errorlog 1>$QANARY_LOG/qanary_component-NERD-Lucene-Linker.outlog &
