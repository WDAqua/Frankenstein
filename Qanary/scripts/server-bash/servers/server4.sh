...
nohup java -jar $QANARY/qanary_component-NED-Dandelion/target/qanary_component-NED-Dandelion-1.0.0.jar 2>$QANARY_LOG/qanary_component-NED-Dandelion.errorlog 1>$QANARY_LOG/qanary_component-NED-Dandelion.outlog &
